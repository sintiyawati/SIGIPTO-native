...
if(!isset($_SESSION['id_admin'])){
    ...
    $sqlll = mysqli_query($koneksi, "SELECT * FROM admin where id_admin='$_SESSION[id_admin]'");
    $admin = mysqli_fetch_array($sqlll);
                            ...
                            <ul class="navbar-nav my-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <?php 
                                        if ($admin['foto_admin']=='') {?>
                                            <img src="profil/foto/icon.png" class="profile-pic" />
                                        <?php }else{?>
                                            <img src="profil/foto/<?php echo $foto; ?>" class="profile-pic" />
                                        <?php } ?>
                                    </a>
                                            ...
                                            <li>
                                                <div class="dw-user-box">
                                                    <div class="u-img">
                                                        <?php 
                                                        if ($admin['foto_admin']=='') {?>
                                                            <img src="profil/foto/icon.png" alt="user" style="border-radius:70px;width: 70px;height: 70px;"/>
                                                        <?php }else{?>
                                                            <img src="profil/foto/<?php echo $foto; ?>" alt="user" style="border-radius:70px;width: 70px;height: 70px;"/>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="u-text">
                                                        <h4><?php echo $nama ?></h4>
                                                        <p class="text-muted"><?php echo $email ?></p><a href="?page=profil/index" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                                    </div>
                                                </li>
                        ...
                        <div class="scroll-sidebar">
                            ...
                            <div class="user-profile">
                                ...
                                <div class="profile-img"> 
                                    <?php 
                                    if ($admin['foto_admin']=='') {?>
                                        <img src="profil/foto/icon.png" alt="user"/>
                                    <?php }else{?>
                                        <img src="profil/foto/<?php echo $foto; ?>" alt="user"/>
                                    <?php } ?>
                                ...
                                <h5><center style="font-weight: bold;">SUPER ADMIN</center></h5>
                            </div>
                            ...
                            <nav class="sidebar-nav">
                                <ul id="sidebarnav">
                                    ...
                                    <li> <a class="waves-effect waves-dark <?php if($_GET['page']=='pemilik_tempat/index' || $_GET['page']=='pemilik_tempat/tambah' || $_GET['page']=='pemilik_tempat/edit' || $_GET['page']=='pemilik_tempat/detail'){echo 'active';} ?>" href="?page=pemilik_tempat/index" href="?page=pemilik_tempat/index" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Pemilik Tempat</span></a>
                                    </li>
    ...
    <script src="assets/plugins/slick/custom-slick.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
