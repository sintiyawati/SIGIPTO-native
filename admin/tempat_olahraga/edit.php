<?php 
$datax = mysqli_query($koneksi,"SELECT * FROM tempat_olahraga WHERE kode_tempat='$_GET[kode_tempat]'");
...
<div class="container-fluid">
    <div class="row">
                ...
                <div class="card-body">
                    ...
                    <form class="m-t-40" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="kode_tempat" value="<?php echo $dat['kode_tempat'] ?>" class="form-control" readonly> </div>
                            </div>
                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="id_pemilik" class="select2 form-control custom-select" style="width: 100%; height:36px;">
                                                    <?php 
                                                    $mysql1 = mysqli_query($koneksi, "SELECT * FROM pemilik_tempat");
                                                    while ($data1 = mysqli_fetch_array($mysql1)) {
                                                     ?>
                                                     <option value="<?php echo $data1['id_pemilik'] ?>" <?php if ($data1['id_pemilik']==$datas['id_pemilik']) {
                                                        echo "selected";
                                ...
                                <div class="box-slider">
                                    <div class="naf-for">
                                        ...
                                        while ($datax = mysqli_fetch_array($mys)) {
                                            ...
                                            ?>
                                            <div class="nav-item">
                                                <img src="tempat_olahraga/gambar/<?php echo $datax['gambar']; ?>" alt="" style="width: 100%;height: 300px; padding: 10px;border-radius: 15px;"> 
                                            </div>
                                        <?php } ?>
                                    </div>
                                    ...
                                    <div class="naf-bottom">
                                        ...
                                        while ($data = mysqli_fetch_array($mysql)) {
                                            ...
                                            <div class="bottom-item">
                                                <img src="tempat_olahraga/gambar/<?php echo $data['gambar'] ?>" alt="" style="height: 150px;display: none;"> 
                                            </div>
                                        <?php } ?>
                                    </div>
        ...
        if (isset($_POST['edit'])) {
          ...
          $updateData = mysqli_query($koneksi, "UPDATE `tempat_olahraga` SET `id_pemilik` = '$id_pemilik', `nama_tempat` = '$nama_tempat', `kategori_tempat` = '$kategori_tempat', `nomor_telepon` = '$nomor_telepon', `alamat_tempat` = '$alamat_tempat', `layanan_tempat` = '$layanan_tempat', `jadwal` = '$jadwal', `deskripsi_tempat` = '$deskripsi_tempat', `latitude` = '$latitude', `longitude` = '$longitude' WHERE id_tempat='$id_tempat'");
