...
<div class="container-fluid">
	<div class="row">
								...
								<tbody>
									...
									while ($d = mysqli_fetch_array($mysql)) {
										...
										<tr>
											...
											<td><center><img src="tempat_olahraga/gambar/<?php echo $d['gambar'] ?>" style="width:150px;height:150px"></center></td>
											<td><center>
		...
		if (isset($_POST['simpan'])) {
		    ...
		    file_exists("tempat_olahraga/gambar/".$us['gambar']);
		    unlink("tempat_olahraga/gambar/".$us['gambar']);
