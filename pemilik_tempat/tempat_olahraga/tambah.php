        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="m-t-40" method="post" action="" enctype="multipart/form-data">
                        <input type="hidden" name="id_pemilik" value="<?php echo $ids ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <h5>Alamat</h5>
                                            <textarea name="alamat_tempat" id="lokasi" class="form-control" required placeholder="Masukkan Alamat tempat olahraga" required oninvalid="this.setCustomValidity('Alamat tidak boleh kosong')" oninput="setCustomValidity('')" autocomplete="off"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <div class="controls">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="gambar[]" type="file" class="form-control" id="image" onchange="loadfile(event)" required placeholder="Nama Gambar" required oninvalid="this.setCustomValidity('Gambar tidak boleh kosong')" oninput="setCustomValidity('')" autocomplete="off" multiple="">
                                        </div>
                                        <div class="form-group">
                                            <h5>Nama Gambar</h5>
                                            <div class="controls">
                                                <textarea name="nama_gambar" id="textarea" class="form-control" required placeholder="Nama Gambar"></textarea>
                                            </div>
                                        </div>
            ...
            if (isset($_POST['simpan'])) {
              ...
              for ($i=0; $i < $jumlahDipilih; $i++) { 
                ...
                if ($inputFolderGambar AND $inputTempat AND $inputGambar){
